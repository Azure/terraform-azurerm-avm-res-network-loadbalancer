...
Description:   A map of objects that builds frontend ip configurations for the load balancer.   
  ...
  - `frontend_private_ip_address_allocation`: (Optional) A string parameter that is the allocation method for the private IP address used by this Load Balancer. Possible values as Dynamic or Static. If value is set to Static, then user must provide frontend_private_ip_address as parameter. 
