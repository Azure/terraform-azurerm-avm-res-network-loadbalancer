...
- [azurerm_lb_backend_address_pool_address.azlb](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/lb_backend_address_pool_address) (resource)
- [azurerm_lb_nat_pool.azlb](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/lb_nat_pool) (resource)
...
- [azurerm_lb_outbound_rule.azlb](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/lb_outbound_rule) (resource)
...
Description:   A list of backend address pool addresses to associate with the backend address pool  
...
Description:   Map of objects that manage a Diagnostic Setting for an existing resource
...
Description:   (Optional) The frontend subnet id to use when in private mode.   
...
Description:   A list of objects that specifies the creation of NAT rules.  
