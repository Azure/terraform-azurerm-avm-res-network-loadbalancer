...
resource "azurerm_lb" "this" {
  ...
  dynamic "frontend_ip_configuration" {
    ...
    content {
      ...
      public_ip_address_id          = frontend_ip_configuration.value.create_public_ip_address ? azurerm_public_ip.azlb[frontend_ip_configuration.key].id : frontend_ip_configuration.value.public_ip_address_resource_id
...
resource "azurerm_lb_rule" "azlb" {
  ...
  probe_id                       = coalesce(azurerm_lb_probe.azlb[each.value.probe_object_name].id, each.value.probe_resource_id)
